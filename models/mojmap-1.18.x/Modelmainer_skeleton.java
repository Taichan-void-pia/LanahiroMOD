...
public class Modelmainer_skeleton<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mainer_skeleton"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(40, 48)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 16)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.1F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition rightArm = partdefinition.addOrReplaceChild("rightArm",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 32)
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(0, 59)
						.addBox(0.0F, 9.0F, -4.9F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.05F)).texOffs(0, 59)
						.addBox(0.0F, 9.0F, 2.9F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.05F)).texOffs(24, 58)
						.addBox(0.0F, 8.0F, -12.2F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F)).texOffs(0, 59)
						.addBox(0.0F, 9.0F, -12.7F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.05F)).texOffs(0, 59)
						.addBox(0.0F, 9.0F, -8.8F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.05F)).texOffs(0, 59)
						.addBox(0.0F, 9.0F, -1.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.05F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition cube_r1 = rightArm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(24, 58).addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 2.0F,
		...
		PartDefinition rightLeg = partdefinition.addOrReplaceChild("rightLeg",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 32)
