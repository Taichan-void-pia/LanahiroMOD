...
public class NightmareRanahiroEntity extends Monster {
	public NightmareRanahiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.NIGHTMARE_RANAHIRO.get(), world);
	}

	public NightmareRanahiroEntity(EntityType<NightmareRanahiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = NightmareRanahiroEntity.this.getX();
				double y = NightmareRanahiroEntity.this.getY();
				double z = NightmareRanahiroEntity.this.getZ();
				Entity entity = NightmareRanahiroEntity.this;
				Level world = NightmareRanahiroEntity.this.level();
