...
public class EpicDownCreeperEntity extends Creeper {
	public EpicDownCreeperEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.EPIC_DOWN_CREEPER.get(), world);
	}

	public EpicDownCreeperEntity(EntityType<EpicDownCreeperEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = EpicDownCreeperEntity.this.getX();
				double y = EpicDownCreeperEntity.this.getY();
				double z = EpicDownCreeperEntity.this.getZ();
				Entity entity = EpicDownCreeperEntity.this;
				Level world = EpicDownCreeperEntity.this.level();
	...
	public static void init() {
		SpawnPlacements.register(RanahiromodModEntities.EPIC_DOWN_CREEPER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return RanahiroMODEntitySpawnConditionProcedure.execute(world, x, y, z);
		});
		DungeonHooks.addDungeonMob(RanahiromodModEntities.EPIC_DOWN_CREEPER.get(), 180);
	}
