...
import net.mcreator.ranahiromod.procedures.AIWaterhiroProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModItems;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class WaterhiroEntity extends Monster {
	...
	public WaterhiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.WATERHIRO.get(), world);
	}

	public WaterhiroEntity(EntityType<WaterhiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§9§k||||||||||||||||§r§1§l==Waterhiro==§r§9§k||||||||||||||||§r"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.WATERHIRO_ITEM.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = WaterhiroEntity.this.getX();
				double y = WaterhiroEntity.this.getY();
				double z = WaterhiroEntity.this.getZ();
				Entity entity = WaterhiroEntity.this;
				Level world = WaterhiroEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AIWaterhiroProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 730);
