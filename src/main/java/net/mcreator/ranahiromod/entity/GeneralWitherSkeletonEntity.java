...
import net.mcreator.ranahiromod.procedures.GeneralSkeletonAIProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class GeneralWitherSkeletonEntity extends Monster {
	public GeneralWitherSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.GENERAL_WITHER_SKELETON.get(), world);
	}

	public GeneralWitherSkeletonEntity(EntityType<GeneralWitherSkeletonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = GeneralWitherSkeletonEntity.this.getX();
				double y = GeneralWitherSkeletonEntity.this.getY();
				double z = GeneralWitherSkeletonEntity.this.getZ();
				Entity entity = GeneralWitherSkeletonEntity.this;
				Level world = GeneralWitherSkeletonEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		GeneralSkeletonAIProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	public static void init() {
		SpawnPlacements.register(RanahiromodModEntities.GENERAL_WITHER_SKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(RanahiromodModEntities.GENERAL_WITHER_SKELETON.get(), 180);
	}
