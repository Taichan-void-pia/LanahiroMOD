...
public class NightmareVazafilaEntity extends Monster {
	public NightmareVazafilaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.NIGHTMARE_VAZAFILA.get(), world);
	}

	public NightmareVazafilaEntity(EntityType<NightmareVazafilaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = NightmareVazafilaEntity.this.getX();
				double y = NightmareVazafilaEntity.this.getY();
				double z = NightmareVazafilaEntity.this.getZ();
				Entity entity = NightmareVazafilaEntity.this;
				Level world = NightmareVazafilaEntity.this.level();
