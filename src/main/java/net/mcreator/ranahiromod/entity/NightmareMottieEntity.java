...
public class NightmareMottieEntity extends Monster {
	public NightmareMottieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.NIGHTMARE_MOTTIE.get(), world);
	}

	public NightmareMottieEntity(EntityType<NightmareMottieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = NightmareMottieEntity.this.getX();
				double y = NightmareMottieEntity.this.getY();
				double z = NightmareMottieEntity.this.getZ();
				Entity entity = NightmareMottieEntity.this;
				Level world = NightmareMottieEntity.this.level();
