...
import net.mcreator.ranahiromod.procedures.AIHypocriteProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class HypocriteEntity extends Monster {
	public HypocriteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.HYPOCRITE.get(), world);
	}

	public HypocriteEntity(EntityType<HypocriteEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = HypocriteEntity.this.getX();
				double y = HypocriteEntity.this.getY();
				double z = HypocriteEntity.this.getZ();
				Entity entity = HypocriteEntity.this;
				Level world = HypocriteEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AIHypocriteProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	public static void init() {
		SpawnPlacements.register(RanahiromodModEntities.HYPOCRITE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
