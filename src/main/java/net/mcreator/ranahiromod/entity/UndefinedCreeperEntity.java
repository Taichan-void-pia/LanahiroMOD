...
public class UndefinedCreeperEntity extends Creeper {
	public UndefinedCreeperEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.UNDEFINED_CREEPER.get(), world);
	}

	public UndefinedCreeperEntity(EntityType<UndefinedCreeperEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = UndefinedCreeperEntity.this.getX();
				double y = UndefinedCreeperEntity.this.getY();
				double z = UndefinedCreeperEntity.this.getZ();
				Entity entity = UndefinedCreeperEntity.this;
				Level world = UndefinedCreeperEntity.this.level();
