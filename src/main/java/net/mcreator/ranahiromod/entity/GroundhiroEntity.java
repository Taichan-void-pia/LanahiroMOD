...
import net.mcreator.ranahiromod.procedures.AIGroundhiroProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModItems;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class GroundhiroEntity extends Monster {
	...
	public GroundhiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.GROUNDHIRO.get(), world);
	}

	public GroundhiroEntity(EntityType<GroundhiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§4§k||||||||||||||||§r§6§l==Groundhiro==§r§4§k||||||||||||||||§r"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.GROUNDHIRO_ITEM.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = GroundhiroEntity.this.getX();
				double y = GroundhiroEntity.this.getY();
				double z = GroundhiroEntity.this.getZ();
				Entity entity = GroundhiroEntity.this;
				Level world = GroundhiroEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AIGroundhiroProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
