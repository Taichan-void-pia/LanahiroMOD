...
import net.mcreator.ranahiromod.procedures.AILavahiroProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModItems;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class LavahiroEntity extends Monster {
	...
	public LavahiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.LAVAHIRO.get(), world);
	}

	public LavahiroEntity(EntityType<LavahiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§c§k||||||||||||||||§r§c§l==Lavahiro==§r§c§k||||||||||||||||§r"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.LAVAHIRO_ITEM.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(RanahiromodModItems.LAVAHIRO_ITEM.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = LavahiroEntity.this.getX();
				double y = LavahiroEntity.this.getY();
				double z = LavahiroEntity.this.getZ();
				Entity entity = LavahiroEntity.this;
				Level world = LavahiroEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AILavahiroProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
