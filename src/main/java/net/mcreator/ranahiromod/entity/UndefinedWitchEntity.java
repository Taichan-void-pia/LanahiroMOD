...
import net.mcreator.ranahiromod.procedures.UndefinedWitchAIProcedure;
...
public class UndefinedWitchEntity extends Witch {
	public UndefinedWitchEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.UNDEFINED_WITCH.get(), world);
	}

	public UndefinedWitchEntity(EntityType<UndefinedWitchEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = UndefinedWitchEntity.this.getX();
				double y = UndefinedWitchEntity.this.getY();
				double z = UndefinedWitchEntity.this.getZ();
				Entity entity = UndefinedWitchEntity.this;
				Level world = UndefinedWitchEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		UndefinedWitchAIProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
