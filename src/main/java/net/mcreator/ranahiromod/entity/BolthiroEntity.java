...
import net.mcreator.ranahiromod.procedures.AIBolthiroProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModItems;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class BolthiroEntity extends Monster {
	...
	public BolthiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.BOLTHIRO.get(), world);
	}

	public BolthiroEntity(EntityType<BolthiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§6§k||||||||||||||||§r§e§l==Volthiro==§r§6§k||||||||||||||||§r"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.BOLTHIRO_ITEM.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Player.class, false, true) {
			...
			public boolean canUse() {
				double x = BolthiroEntity.this.getX();
				double y = BolthiroEntity.this.getY();
				double z = BolthiroEntity.this.getZ();
				Entity entity = BolthiroEntity.this;
				Level world = BolthiroEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AIBolthiroProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
