...
import net.mcreator.ranahiromod.procedures.PhotonServantVanishAIProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModItems;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class PhotonServantEntity extends Monster {
	public PhotonServantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.PHOTON_SERVANT.get(), world);
	}

	public PhotonServantEntity(EntityType<PhotonServantEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 3;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.PHOTON_SWORD.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new HurtByTargetGoal(this) {
			...
			public boolean canUse() {
				double x = PhotonServantEntity.this.getX();
				double y = PhotonServantEntity.this.getY();
				double z = PhotonServantEntity.this.getZ();
				Entity entity = PhotonServantEntity.this;
				Level world = PhotonServantEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		PhotonServantVanishAIProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
