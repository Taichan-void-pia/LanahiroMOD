...
public class UndefinedZombieEntity extends Monster {
	public UndefinedZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.UNDEFINED_ZOMBIE.get(), world);
	}

	public UndefinedZombieEntity(EntityType<UndefinedZombieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.GALRADNULL.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(RanahiromodModItems.GALRADNULL.get()));
		refreshDimensions();
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = UndefinedZombieEntity.this.getX();
				double y = UndefinedZombieEntity.this.getY();
				double z = UndefinedZombieEntity.this.getZ();
				Entity entity = UndefinedZombieEntity.this;
				Level world = UndefinedZombieEntity.this.level();
