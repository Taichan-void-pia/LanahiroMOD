...
public class GodTaichanEntity extends Monster {
	public GodTaichanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.GOD_TAICHAN.get(), world);
	}

	public GodTaichanEntity(EntityType<GodTaichanEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = GodTaichanEntity.this.getX();
				double y = GodTaichanEntity.this.getY();
				double z = GodTaichanEntity.this.getZ();
				Entity entity = GodTaichanEntity.this;
				Level world = GodTaichanEntity.this.level();
