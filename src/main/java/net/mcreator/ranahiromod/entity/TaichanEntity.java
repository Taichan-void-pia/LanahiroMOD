...
public class TaichanEntity extends Monster {
	public TaichanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.TAICHAN.get(), world);
	}

	public TaichanEntity(EntityType<TaichanEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.TAICHAN_BOW.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = TaichanEntity.this.getX();
				double y = TaichanEntity.this.getY();
				double z = TaichanEntity.this.getZ();
				Entity entity = TaichanEntity.this;
				Level world = TaichanEntity.this.level();
	...
	public static void init() {
		SpawnPlacements.register(RanahiromodModEntities.TAICHAN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
