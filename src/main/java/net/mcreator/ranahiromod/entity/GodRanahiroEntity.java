...
public class GodRanahiroEntity extends Monster {
	public GodRanahiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.GOD_RANAHIRO.get(), world);
	}

	public GodRanahiroEntity(EntityType<GodRanahiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = GodRanahiroEntity.this.getX();
				double y = GodRanahiroEntity.this.getY();
				double z = GodRanahiroEntity.this.getZ();
				Entity entity = GodRanahiroEntity.this;
				Level world = GodRanahiroEntity.this.level();
