...
import net.mcreator.ranahiromod.procedures.AIKnightOfLightningProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class KnightOfLightningEntity extends Monster {
	...
	public KnightOfLightningEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.KNIGHT_OF_LIGHTNING.get(), world);
	}

	public KnightOfLightningEntity(EntityType<KnightOfLightningEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = KnightOfLightningEntity.this.getX();
				double y = KnightOfLightningEntity.this.getY();
				double z = KnightOfLightningEntity.this.getZ();
				Entity entity = KnightOfLightningEntity.this;
				Level world = KnightOfLightningEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AIKnightOfLightningProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public static void init() {
		SpawnPlacements.register(RanahiromodModEntities.KNIGHT_OF_LIGHTNING.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
