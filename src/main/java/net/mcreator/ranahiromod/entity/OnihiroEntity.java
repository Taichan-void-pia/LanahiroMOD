...
import net.mcreator.ranahiromod.procedures.AIOnihiroProcedure;
import net.mcreator.ranahiromod.init.RanahiromodModItems;
import net.mcreator.ranahiromod.init.RanahiromodModEntities;

import javax.annotation.Nullable;

public class OnihiroEntity extends Monster {
	...
	public OnihiroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.ONIHIRO.get(), world);
	}

	public OnihiroEntity(EntityType<OnihiroEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		setCustomName(Component.literal("§4§k||||||||||||||||§r§4§l==Demonhiro==§r§4§k||||||||||||||||§r"));
		setCustomNameVisible(true);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(RanahiromodModItems.ONIHIRO_ITEM.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(RanahiromodModItems.ONIHIRO_ITEM.get()));
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = OnihiroEntity.this.getX();
				double y = OnihiroEntity.this.getY();
				double z = OnihiroEntity.this.getZ();
				Entity entity = OnihiroEntity.this;
				Level world = OnihiroEntity.this.level();
	...
	public void baseTick() {
		super.baseTick();
		AIOnihiroProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
