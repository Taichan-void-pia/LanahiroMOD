...
public class UndefinedSkeletonEntity extends Skeleton {
	public UndefinedSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RanahiromodModEntities.UNDEFINED_SKELETON.get(), world);
	}

	public UndefinedSkeletonEntity(EntityType<UndefinedSkeletonEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, LivingEntity.class, false, true) {
			...
			public boolean canUse() {
				double x = UndefinedSkeletonEntity.this.getX();
				double y = UndefinedSkeletonEntity.this.getY();
				double z = UndefinedSkeletonEntity.this.getZ();
				Entity entity = UndefinedSkeletonEntity.this;
				Level world = UndefinedSkeletonEntity.this.level();
