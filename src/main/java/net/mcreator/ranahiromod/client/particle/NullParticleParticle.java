...
@OnlyIn(Dist.CLIENT)
public class NullParticleParticle extends TextureSheetParticle {
	public static NullParticleParticleProvider provider(SpriteSet spriteSet) {
		return new NullParticleParticleProvider(spriteSet);
	}

	public static class NullParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new NullParticleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
