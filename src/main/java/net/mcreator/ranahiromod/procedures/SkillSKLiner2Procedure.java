...
public class SkillSKLiner2Procedure {
					...
					for (int index2 = 0; index2 < 6; index2++) {
						...
						if (world instanceof ServerLevel _level)
							_level.getServer().getCommands().performPrefixedCommand(
									...
									"particle dust_color_transition 0.500 1.000 1.000 1 0.350 0.250 1.000 ~ ~ ~ 0 0 0 0.05 1 force");
					...
					if (logic_attack) {
						for (int index7 = 0; index7 < 5; index7++) {
							if (world instanceof ServerLevel _level)
								_level.getServer().getCommands().performPrefixedCommand(
										new CommandSourceStack(CommandSource.NULL, new Vec3(xPos, yPos, zPos), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
										"particle dust_color_transition 0.500 1.000 1.000 1 0.350 0.250 1.000 ~ ~ ~ 0.3 0.3 0.3 1 2 force");
						}
