...
public class KnightSkill2Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		double dis_count = 0;
		double yaw = 0;
		UseSK = entity instanceof GeneralWitherSkeletonEntity;
						...
						if (UseSK) {
							if (Math.random() < 0.1) {
								if (world instanceof ServerLevel _level)
									_level.sendParticles(ParticleTypes.DRAGON_BREATH, xPos, yPos, zPos, 15, 0.2, 0.2, 0.2, 0.05);
							}
							if (world instanceof ServerLevel _level)
								_level.sendParticles(ParticleTypes.WITCH, xPos, yPos, zPos, 8, 0.2, 0.2, 0.2, 0.1);
						} else {
							if (Math.random() < 0.1) {
								if (world instanceof ServerLevel _level)
									_level.sendParticles(ParticleTypes.CLOUD, xPos, yPos, zPos, 15, 0.2, 0.2, 0.2, 0.05);
							}
							if (world instanceof ServerLevel _level)
