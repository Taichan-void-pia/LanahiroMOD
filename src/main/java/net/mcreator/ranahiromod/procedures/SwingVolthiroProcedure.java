...
public class SwingVolthiroProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		entity.getPersistentData().putString("color1", "0.96 0.94 0.2 1");
		entity.getPersistentData().putString("color2", "0.78 0.76 0.22 1");
