...
public class SwingWaterhiroProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		entity.getPersistentData().putString("color1", "0.361 0.745 1.000 1");
		entity.getPersistentData().putString("color2", "0 0 0.5 1");
		entity.getPersistentData().putString("color3", "minecraft:end_rod");
