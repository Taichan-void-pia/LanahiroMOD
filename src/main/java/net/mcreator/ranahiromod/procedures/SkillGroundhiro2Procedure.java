...
public class SkillGroundhiro2Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getDouble("cnt1") < 10) {
			...
			if (entity.getPersistentData().getDouble("cnt3") > 0) {
				...
				for (int index0 = 0; index0 < 10; index0++) {
					...
					for (int index1 = 0; index1 < 2; index1++) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles(ParticleTypes.TOTEM_OF_UNDYING, xPos, yPos, zPos, 1, 0, 0, 0, 0.2);
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (RanahiromodModParticleTypes.SMOKE_WIND.get()), xPos, yPos, zPos, 2, 0, 0, 0, 0.1);
				...
				if (entity.getPersistentData().getDouble("cnt1") >= 10) {
					entity.getPersistentData().putDouble("cnt1", 10);
				}
			}
		}
	}
