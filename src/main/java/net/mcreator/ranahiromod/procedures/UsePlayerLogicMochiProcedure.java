...
public class UsePlayerLogicMochiProcedure {
	public static boolean execute(Entity entity) {
		...
		UseSK = false;
		if (entity instanceof Mottie07172Entity || entity instanceof Player && ((entity.getDisplayName().getString()).equals("Mottie0717")
