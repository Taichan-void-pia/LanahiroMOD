...
public class SwingWindhiroProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		entity.getPersistentData().putString("color1", "0.129 1.000 0.537 1");
		entity.getPersistentData().putString("color2", "0.059 0.439 0.235 1");
		entity.getPersistentData().putString("color3", "minecraft:enchanted_hit");
