...
public class AIWindhiroProcedure {
							...
							for (Entity entityiterator : _entfound) {
								if ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == entityiterator) {
									if (entityiterator instanceof Player) {
										if ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(MobEffects.LEVITATION) ? _livEnt.getEffect(MobEffects.LEVITATION).getAmplifier() : 0) >= 0) {
											if (!((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(MobEffects.SLOW_FALLING) ? _livEnt.getEffect(MobEffects.SLOW_FALLING).getAmplifier() : 0) >= 0)) {
												if (entityiterator instanceof LivingEntity _entity)
													_entity.setHealth(0);
											}
										}
										if (entityiterator instanceof Player _player && !_player.level().isClientSide())
											_player.displayClientMessage(Component.literal((("\uFF0A" + entity.getDisplayName().getString()) + "\u306F\u81EA\u7531\u843D\u4E0B\u3092\u5531\u3048\u305F\uFF01")), false);
										if (entityiterator instanceof Player _player && !_player.level().isClientSide())
											_player.displayClientMessage(Component.literal((("\uFF0A" + entity.getDisplayName().getString()) + "\u306F\u81EA\u7531\u6D6E\u904A\u3092\u5531\u3048\u305F\uFF01")), false);
										if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
											_entity.addEffect(new MobEffectInstance(MobEffects.LEVITATION, 340, 0, false, false));
								...
								if (entityiterator instanceof Player _player && !_player.level().isClientSide())
									_player.displayClientMessage(Component.literal((("\uFF0A" + entity.getDisplayName().getString()) + "\u306F\u81EA\u7531\u306A\u7FFC\u3092\u5531\u3048\u305F\uFF01")), false);
								if (entityiterator instanceof Player _player && !_player.level().isClientSide())
