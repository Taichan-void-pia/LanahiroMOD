...
public class NBTBlockLogicSetProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				_blockEntity.getPersistentData().putBoolean((StringArgumentType.getString(arguments, "tagname")), (BoolArgumentType.getBool(arguments, "logic")));
		...
		if (entity instanceof Player _player && !_player.level().isClientSide())
			_player.displayClientMessage(Component.literal(((("X:" + Math.round(x_pos)) + "" + ("Y:" + Math.round(y_pos)) + ("Z:" + Math.round(z_pos))) + "" + ("\u306B\u4F4D\u7F6E\u3059\u308B\u30D6\u30ED\u30C3\u30AF\u306E"
					+ StringArgumentType.getString(arguments, "tagname") + "\u3092" + BoolArgumentType.getBool(arguments, "logic") + "\u306B\u8A2D\u5B9A\u3057\u307E\u3057\u305F\u3002"))), false);
	}
}
