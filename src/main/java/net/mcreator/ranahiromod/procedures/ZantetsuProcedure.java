...
public class ZantetsuProcedure {
				...
				if (!(entityiterator == entity)) {
					if (entityiterator instanceof LivingEntity) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles(ParticleTypes.SWEEP_ATTACK, x, (y + entityiterator.getBbHeight() / 2), z, 1, (entityiterator.getBbWidth()), (entityiterator.getBbHeight() / 2), (entityiterator.getBbWidth()), 0);
