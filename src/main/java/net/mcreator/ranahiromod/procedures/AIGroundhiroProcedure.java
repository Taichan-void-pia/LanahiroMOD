...
public class AIGroundhiroProcedure {
							...
							for (Entity entityiterator : _entfound) {
								if (entityiterator == (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null)) {
									if (entityiterator instanceof Player) {
										if (!(entityiterator instanceof LivingEntity _livEnt23 && _livEnt23.hasEffect(MobEffects.MOVEMENT_SLOWDOWN))) {
											if (entityiterator instanceof LivingEntity _entity)
												_entity.setHealth(0);
										}
										if (entityiterator instanceof Player _player && !_player.level().isClientSide())
											_player.displayClientMessage(Component.literal(("\uFF0A" + entity.getDisplayName().getString() + "\u306F\u75BE\u795E\u6BBA\u3092\u5531\u3048\u305F\uFF01")), false);
								...
								if (entityiterator instanceof Player _player && !_player.level().isClientSide())
									_player.displayClientMessage(Component.literal(("\uFF0A" + entity.getDisplayName().getString() + "\u306F\u770B\u5B88\u53EC\u559A\u3092\u5531\u3048\u305F\uFF01")), false);
								if (entityiterator instanceof Player _player && !_player.level().isClientSide())
									_player.displayClientMessage(Component.literal(("\uFF0A" + entity.getDisplayName().getString() + "\u306F\u5C6F\u7530\u5175\u53EC\u559A\u3092\u5531\u3048\u305F\uFF01")), false);
								if (entityiterator instanceof Player _player && !_player.level().isClientSide())
									_player.displayClientMessage(Component.literal(("\uFF0A" + entity.getDisplayName().getString() + "\u306F\u4E0B\u50D5\u53EC\u559A\u3092\u5531\u3048\u305F\uFF01")), false);
							}
						}
