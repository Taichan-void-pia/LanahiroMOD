...
import net.mcreator.ranahiromod.procedures.AIWeaponhiroProcedure;

public class WeaponhiroItemItem extends SwordItem {
	public WeaponhiroItemItem() {
		super(new Tier() {
			public int getUses() {
				return 5463;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			AIWeaponhiroProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
	}
}
